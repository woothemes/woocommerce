...
-   [PNPM](https://pnpm.io/installation): Our repository utilizes PNPM version 9.15.0 to manage project dependencies and run various scripts involved in building and testing projects.
