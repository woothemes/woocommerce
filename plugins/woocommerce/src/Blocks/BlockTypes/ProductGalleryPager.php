...
class ProductGalleryPager extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		...
		if ( $product && $product_gallery_images_ids ) {
			$product_gallery_images_ids = ProductGalleryUtils::get_product_gallery_image_ids( $product );
			$html                       = $this->render_pager( $product_gallery_images_ids, $pager_display_mode );
	 ...
	 */
	private function render_pager( $product_gallery_images_ids, $pager_display_mode ) {
		return $this->render_pager_pages( $product_gallery_images_ids, $pager_display_mode );
	}
	 ...
	 */
	private function render_pager_pages( $product_gallery_images_ids, $pager_display_mode = 'dots' ) {
		$html = '';
