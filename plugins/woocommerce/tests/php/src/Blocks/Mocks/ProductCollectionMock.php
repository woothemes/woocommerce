...
class ProductCollectionMock extends ProductCollectionController {
	...
	public function register_collection_handlers( $collection_name, $build_query, $frontend_args = null, $editor_args = null, $preview_query = null ) {
		$handlers = $this->collection_registry->register_collection_handlers( $collection_name, $build_query, $frontend_args, $editor_args, $preview_query );
	...
	public function unregister_collection_handlers( $collection_name ) {
		$this->collection_registry->unregister_collection_handlers( $collection_name );
	}
}
