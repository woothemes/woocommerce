...
class PaymentProvidersTest extends WC_Unit_Test_Case {
	...
	public function test_get_payment_gateways() {
		...
		$this->assertEquals(
			array( PaymentMethods::BACS, PaymentMethods::CHEQUE, PaymentMethods::COD, PaymentMethods::PAYPAL ),
	...
	public function test_get_payment_gateway_plugin_slug() {
		...
		$paypal_gateway = array_filter(
			...
			function ( $gateway ) {
				return PaymentMethods::PAYPAL === $gateway->id;
			}
		);
	...
	public function data_provider_test_update_payment_providers_order_map(): array {
		...
		return array(
			...
			'empty start, move offline PMs - gateways | offline PMs | suggestions'    => array(
				array(),
				array(
					PaymentMethods::CHEQUE => 1,
					PaymentMethods::BACS   => 2,
				),
				array(
					'_wc_pes_suggestion1',
					'gateway1',
			...
			'new order with suggestions but no matching gateways, ordering #3 - gateways | offline PMs | suggestions'       => array(
				...
				array(
					PaymentMethods::BACS   => 0, // Special offline PMs normalized order map - no-op.
					PaymentMethods::COD    => 1,
					PaymentMethods::CHEQUE => 2,
				),
				array(
					'_wc_pes_suggestion3',
					'gateway3_0', // Suggestion matching gateways (via the plugin slug) are added after their suggestion, in order.
			...
			'new order with suggestions but no matching gateways, ordering #4 - gateways | offline PMs | suggestions'       => array(
				...
				array(
					PaymentMethods::COD    => 0, // Special offline PMs normalized order map.
					PaymentMethods::BACS   => 1,
					PaymentMethods::CHEQUE => 2,
				),
				array(
					'_wc_pes_suggestion3',
			...
			'new order with suggestions but no matching gateways, ordering #5 - gateways | offline PMs | suggestions'       => array(
				array(
					'_wc_pes_suggestion3',
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS, // This has order 2.
					PaymentMethods::COD,
					PaymentMethods::CHEQUE,
					'_wc_pes_suggestion1',
					'gateway2',
				...
				array(
					PaymentMethods::COD    => 2, // Special offline PMs non-normalized order map.
					PaymentMethods::BACS   => 3,
					PaymentMethods::CHEQUE => 4,
				),
				array(
					'_wc_pes_suggestion3',
					'gateway3_0', // Suggestion matching gateways (via the plugin slug) are added after their suggestion, in order.
			...
			'new order, move payment gateway #3 - gateways | offline PMs | suggestions'    => array(
				array(
					...
					'gateway3_0',
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS, // This has order 3.
					PaymentMethods::COD,
					PaymentMethods::CHEQUE,
					'gateway2',
					'gateway3_1',
			...
			'new order, move offline PMs group on itself #2 - gateways | offline PMs | suggestions'    => array(
				array(
					...
					PaymentMethods::BACS,
					PaymentMethods::COD,
					PaymentMethods::CHEQUE, // This has order 5.
					'gateway2',
					'gateway3_1',
					'_wc_pes_suggestion1',
					'gateway1',
			...
			'new order, move offline PM - gateways | offline PMs | suggestions'    => array(
				array(
					...
					'gateway3_0',
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS, // This had order 3.
					PaymentMethods::COD,
					PaymentMethods::CHEQUE,
					'gateway2',
					'gateway3_1',
			...
			'new order, move offline PM #2 - gateways | offline PMs | suggestions'    => array(
				array(
					...
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS,
					PaymentMethods::COD, // This had order 4.
					PaymentMethods::CHEQUE,
					'gateway2',
					'gateway3_1',
					'_wc_pes_suggestion1',
				...
				array(
					...
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::COD,
					PaymentMethods::BACS, // Because the offline PG was present, the reordering took place only inside the offline PMs group.
					PaymentMethods::CHEQUE,
					'gateway2',
					'gateway3_1',
					'_wc_pes_suggestion1',
			...
			'new order, move offline PM #3 - gateways | offline PMs | suggestions'    => array(
				array(
					...
					PaymentMethods::BACS,
					PaymentMethods::COD,
					PaymentMethods::CHEQUE, // This had order 5.
					'gateway2',
					'gateway3_1',
					'_wc_pes_suggestion1',
					'gateway1',
			...
			'new order, move only offline PMs #1 - gateways | offline PMs | suggestions'    => array(
				...
				array(
					PaymentMethods::BACS   => 4,
					PaymentMethods::COD    => 5,
					PaymentMethods::CHEQUE => 6,
				),
				array(
					'_wc_pes_suggestion3',
					'gateway3_0',
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS, // No change here because the ordering was done inside the offline PMs group.
					PaymentMethods::COD,
					PaymentMethods::CHEQUE,
					'gateway2',
					'gateway3_1',
			...
			'new order, move only offline PMs #2 - gateways | offline PMs | suggestions'    => array(
				...
				array(
					PaymentMethods::BACS   => 4, // Sorting doesn't matter.
					PaymentMethods::COD    => 3,
					PaymentMethods::CHEQUE => 5,
				),
				array(
					'_wc_pes_suggestion3',
					'gateway3_0',
			...
			'new order, move suggestion lower #3 - no gateways | offline PMs | suggestions'    => array(
				array(
					...
					PaymentProviders::OFFLINE_METHODS_ORDERING_GROUP,
					PaymentMethods::BACS,
					PaymentMethods::COD, // This has order 3.
					PaymentMethods::CHEQUE,
					'_wc_pes_suggestion-other',
					'_wc_pes_suggestion1',
				),
