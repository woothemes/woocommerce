...
* Fix - Added new validation to Store API checkout endpoint regarding Accounts & Privacy definitions. [#53422](https://github.com/woocommerce/woocommerce/pull/53422)
...
* Fix - Updated wc_get_cart_url() to only return permalinks rather than building the current URL manually. [#53420](https://github.com/woocommerce/woocommerce/pull/53420)
* Fix - Validate and sanitize the event origin and event data when listening to message events from attachParentListeners function to prevent xss attacks during the customize your store flow [#53417](https://github.com/woocommerce/woocommerce/pull/53417)
