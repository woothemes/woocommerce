...
* Update - Updated product settings to use locale-specific weight and dimension units based on the store’s country. [#53652](https://github.com/woocommerce/woocommerce/pull/53652)
