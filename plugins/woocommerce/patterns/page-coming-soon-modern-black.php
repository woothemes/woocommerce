...
<div class="wp-block-woocommerce-coming-soon woocommerce-coming-soon-modern-black wp-block-woocommerce-background-color">
	<!-- wp:cover {"url":"<?php echo esc_url( $default_image ); ?>","dimRatio":50,"isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","sizeSlug":"full","className":"is-dark coming-soon-is-vertically-aligned-center coming-soon-cover","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-cover is-dark coming-soon-is-vertically-aligned-center coming-soon-cover" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;min-height:100vh">
		<span aria-hidden="true" class="wp-block-cover__background has-background-dim"></span>
		<img class="wp-block-cover__image-background size-full" alt="" src="<?php echo esc_url( $default_image ); ?>" data-object-fit="cover"/>
		<div class="wp-block-cover__inner-container">
			<!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":"100vh"},"spacing":{"padding":{"top":"0","bottom":"46px","left":"0","right":"0"},"margin":{"top":"0","bottom":"0px"},"blockGap":"0"},"position":{"type":""}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between","justifyContent":"stretch"}} -->
			<div class="wp-block-group alignwide" style="min-height:100vh;margin-top:0;margin-bottom:0px;padding-top:0;padding-right:0;padding-bottom:46px;padding-left:0">
				<!-- wp:group {"align":"wide","style":{"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
				<div class="wp-block-group alignwide">
					<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","orientation":"horizontal"}} -->
