...
class WC_Post_Types {
	...
	public static function register_post_status() {
		...
		$order_statuses = apply_filters(
			...
			array(
				OrderLegacyStatus::PENDING    => array(
				...
				OrderLegacyStatus::PROCESSING => array(
				...
				OrderLegacyStatus::ON_HOLD    => array(
				...
				OrderLegacyStatus::COMPLETED  => array(
				...
				OrderLegacyStatus::CANCELLED  => array(
				...
				OrderLegacyStatus::REFUNDED   => array(
				...
				OrderLegacyStatus::FAILED     => array(
